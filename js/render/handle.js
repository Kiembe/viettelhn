...
export function handleRender(item) {
    ...
    `
        } else if (e.detail.data && e.detail.data != ""
            && e.detail.freeCall && e.detail.freeCall != ""
            && e.detail.freeApp && e.detail.freeApp != ""
            && e.detail.freeSms && e.detail.freeSms != ""
    ...
    `
    } else if (e.detail.freeCall && e.detail.freeCall != ""
        && e.detail.freeApp && e.detail.freeApp != "") {
        return `
    ...
    `
    } else if (e.detail.freeApp && e.detail.freeApp != ""
        && e.detail.freeSms && e.detail.freeSms != "") {
        return `
    ...
    `
    } else if (e.detail.freeInCall && e.detail.freeInCall != ""
        ...
        `
            ...
            `
        } else if (e.detail.freeSms && e.detail.freeSms != "") {
            return `
